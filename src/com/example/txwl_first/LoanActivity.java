...
public class LoanActivity extends Activity implements AddItem{
     ...
     */
    //车贷详情描述字段
    protected String[] car_owner_des_show = {"这个车子外观9成新，开了5万公里","CA7165AT4","5002361999322110765","傅旭东照片","借款协议书"};

    //车贷详情图片背景
    protected Integer[] car_own_images_show = {R.drawable.btn_car_surface_image_selector,R.drawable.btn_car_engine_number_selector,
            R.drawable.btn_car_pager_image_selector,R.drawable.btn_car_head_image_selector,R.drawable.btn_car_contact_image_selector};

    //房贷详情图片背景
    protected Integer[] house_own_image_show = {R.drawable.btn_house_surface_selector,R.drawable.btn_house_pager_number_selector,
            R.drawable.btn_house_pager_number_selector,R.drawable.btn_house_head_image_selector,R.drawable.btn_car_contact_image_selector};

    //信用贷详情图片背景
    protected Integer[] credit_own_image_show = {R.drawable.loan_pager_image_selector,R.drawable.btn_loan_head_image_selector,
            R.drawable.btn_car_contract_image_selector};

    //其它贷款详情图片背景
    protected Integer[] other_own_image_show = {R.drawable.loan_pager_image_selector,R.drawable.btn_loan_head_image_selector,
            R.drawable.btn_car_contract_image_selector};

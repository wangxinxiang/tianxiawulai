...
public class BlackListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if("5".equals(item.getRegisttype())){
            //registtype 为5 表示为老赖 不显示悬赏信息和悬赏人号码
            holderView.tv_reward.setVisibility(View.INVISIBLE);
            holderView.tv_contact.setVisibility(View.INVISIBLE);
        }else {
            holderView.tv_reward.setVisibility(View.VISIBLE);
            holderView.tv_contact.setVisibility(View.VISIBLE);
